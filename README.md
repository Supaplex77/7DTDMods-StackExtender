# This mod is obsolete because game holds stack size variable size as 16-bit which is 65535 as max hardcoded stack limit. Mod will be tried after v1.2+ updates in game.
